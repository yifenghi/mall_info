...
class=com.doodod.mall.visit.VisitFloorLauncher
...
input_total="$visit_floor/$dir_yesterday"
...
if [ $hour_tag == "00:00" ]
then
   hmv "$visit_floor/$dir_today_last" "$visit_floor/$dir_today_last.bak"
   hcp "$output" "$visit_floor/$dir_today_last" 
fi
