...
class=com.doodod.mall.statistic.FlowMallShopLauncher
...
input_shop="$statistic/shop/$dir_name"
output="$flow_mall_shop/$dir_name"
...
-D mapreduce.input.fileinputformat.inputdir="$input_shop" \
