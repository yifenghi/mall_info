...
//	}
	...
	public void map(Text key, BytesWritable value, Context context)
		...
		if (mallId == 0) {
			context.getCounter(jobCounter.MALLID_ERROR).increment(1);
			return;
		}
...
//				/ Common.MINUTE_FORMATER;
		dwell = TimeCluster.getTimeDwell(cb.build(), Common.DEFAULT_DWELL_PASSENGER)
				/ Common.MINUTE_FORMATER;
		...
		Text outkey= new Text(mallId + Common.CTRL_A + key.toString());
