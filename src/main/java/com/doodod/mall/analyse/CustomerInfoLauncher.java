...
public class CustomerInfoLauncher extends Configured implements Tool {

	public static void main(String[] args) throws Exception {
		System.exit(
				ToolRunner.run(new Configuration(), new CustomerInfoLauncher(), args));
	}
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(CustomerInfoLauncher.class);
