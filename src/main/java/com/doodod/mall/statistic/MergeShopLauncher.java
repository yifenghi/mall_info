...
public class MergeShopLauncher extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(MergeShopLauncher.class);
		job.setReducerClass(MergeShopReducer.class);
	...
	public static void main(String[] args) throws Exception {
		System.exit(
				ToolRunner.run(new Configuration(), new MergeShopLauncher(), args));
	}
