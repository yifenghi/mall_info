...
public class VisitFloorLauncher extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(VisitFloorLauncher.class);
		job.setReducerClass(VisitFloorReducer.class);
		...
		MultipleInputs.addInputPath(job,
				...
				SequenceFileInputFormat.class, VisitFloorMapper.class);
		MultipleInputs.addInputPath(job,
	...
	public static void main(String[] args) throws Exception {
		System.exit(
				ToolRunner.run(new Configuration(), new VisitFloorLauncher(), args));
	}
}
